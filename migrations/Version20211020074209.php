 ...
 */
final class Version20211020074209 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT AUTO_INCREMENT NOT NULL, category_id_id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_169E6FB99777D11E (category_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE course_class (id INT AUTO_INCREMENT NOT NULL, teacher_id_id INT NOT NULL, course_id_id INT NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_4E01E772EBB220A (teacher_id_id), INDEX IDX_4E01E7796EF99BF (course_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
